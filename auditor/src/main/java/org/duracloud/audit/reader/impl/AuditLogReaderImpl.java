...
public class AuditLogReaderImpl implements AuditLogReader {
    ...
    protected StorageProvider getStorageProvider() {
        if (!duracloudConfigBean.getSwiftEndpoint().isEmpty()) {
            ...
            return new SwiftStorageProvider(duracloudConfigBean.getSwiftAccessKey(),
                    duracloudConfigBean.getSwiftSecretKey(), map);
        } else {
