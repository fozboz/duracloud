...
public class SQSTaskQueueTest extends EasyMockSupport {
    ...
    private void setupSQSClient() {
        expect(sqsClient.getQueueUrl(new GetQueueUrlRequest()
            ...
            .andReturn(new GetQueueUrlResult().withQueueUrl("/sqstasktest/" + queueName));
        expect(sqsClient.getQueueAttributes(
            ...
            .andReturn(new GetQueueAttributesResult()
                           .addAttributesEntry(QueueAttributeName.VisibilityTimeout.name(), "300"));
    }
    ...
    public void testPut() {
        ...
        expect(this.sqsClient.sendMessage(isA(SendMessageRequest.class)))
